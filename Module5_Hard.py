...
class UrTube:
    ...
    def log_out(self):
        print(f'Еще увидимся с вами {self.current_user.nickname}')
        self.current_user = None

    def add(self, *arg):
        for new_video in arg:
...
ur.register('SuperMan', 3456789, 43)
ur.watch_video('Для чего девушкам парень программист?')
ur.log_in('Batman', 12345)
